...
public class LMPNotificationService extends NotificationListenerService {

    private static final String TAG = "LMPNotificationService";

    private static LMPNotificationService service;
    ...
    public void onNotificationPosted(final StatusBarNotification sbn) {
        ...
        LMPAccessibilityService.handeNotificationPosted(new IStatusBarNotification() {
            @Override
